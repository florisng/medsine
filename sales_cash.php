	...
	<body>
		...
		<div id="welcome">
			...
			<div id="entete">
								...
								<span class="titre">Sales - Cash 100 % </span>
								<a href="invoices_cash.php" class="btn">Invoices</a>
				...
				<?php
								...
								echo "<img src='img/warning.png' class='small' /> <b>Error !!!</b> Invalid year value: '<b>".$_GET["year"]."</b>' !!!";
									...
									echo "<img src='img/warning.png' class='small' /> <b>Error !!!</b> The username '<b>".$_GET["username"]."</b>' does NOT exist !!!";
														...
														$com = new Commande();
														$com->search_sales_by_type($_GET["month"], $_GET["year"], $product, $_GET["username"], "cash");
													}
												}
											}
										}
